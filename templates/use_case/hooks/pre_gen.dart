...
Future<void> run(HookContext context) async {
  var useCaseName =
      (context.vars["use_case_name"] as String? ?? "").trim().pascalCase;
  final featureName =
  ...
  context.vars = {
    ...
    "use_case_absolute_path":
        "../lib/${featurePath}/domain/use_cases/$useCaseFileName",
    "failure_absolute_path":
        "../lib/${featurePath}/domain/model/$failureFileName",
    "use_case_test_absolute_path":
        "../test/${featurePath}/domain/${stem.snakeCase}_use_case_test.dart",
    'feature': featureName,
  };
